...
Route::post('/mysessions/{id}', [App\Http\Controllers\SessionRequestController::class, 'update'])->name('user');


Route::get('/resetPassword', [App\Http\Controllers\Auth\ResetPasswordController::class, 'index'])->name('resetPassword');
Route::post('/resetPassword', [App\Http\Controllers\Auth\ResetPasswordController::class, 'resetPassword'])->name('resetPassword');
